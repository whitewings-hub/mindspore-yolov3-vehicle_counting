...
class DetectionEngine:
    ...
    def draw_boxes_in_image(self, img_path):
        ...
        imgzi = cv2.putText(img, result_str, (20, 20), font, 0.8, (0, 0, 255), 2)
        print(num_record)
...
def parse_args():
    ...
    # network related
    parser.add_argument('--pretrained', required=True, default='./ckpt_files/608_32batch_add/0-320_64640.ckpt',
                        type=str,
