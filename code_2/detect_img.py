...
def network_load(pretrained_path='./ckpt_files/608_32batch_add/0-320_64640.ckpt'):
...
def img_predict(network, image_path=""):
    ...
    cv2.imwrite(os.path.join(args.output_dir, 'imgs/output1.jpg'), img)


if __name__ == "__main__":
    model = network_load(pretrained_path='./ckpt_files/608_32batch_add/0-320_64640.ckpt')
    img_predict(model, "./imgs/test3.jpg")
