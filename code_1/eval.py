...
class DetectionEngine:
    ...
    def __init__(self, args):
        ...
        self.labels = ['ignored region', 'pedestrian', 'people', 'bicycle', 'car', 'van', 'truck', 'tricycle', 'awning-tricycle',
                       'bus', 'motor', 'others']
...
def run_test():
    ...
    config.data_root = os.path.join(config.data_dir, 'images')
    config.annFile = os.path.join(config.data_dir, 'annotations/eval_annotations.json')
